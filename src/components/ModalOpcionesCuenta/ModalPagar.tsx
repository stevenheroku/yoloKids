...
const Item = ({title, type, navigation, icon}: any) => {
  return (
    <TouchableOpacity activeOpacity={0.5}>
      <View style={styles.item}>
        ...
        <View style={{flexDirection: 'column', marginLeft: 10}}>
          ...
          <View style={styles.descripcionContainer}></View>
        </View>
...
// Modal de transferir
export const ModalPagar = ({visible, onClose, navigation}: any) => {
      ...
      <View style={styles.overlayContainer}>
        ...
        <View style={styles.formContainer}>
          ...
          <View style={{top: -80, flexDirection: 'row'}}>
            <Text style={styles.titlePrincipal}>Pagar</Text>
            <TouchableOpacity
              onPress={() => onClose()}
          ...
          <View style={styles.formContainer}>
            ...
            <Text style={styles.tituloText}>Selecciona el pago a realizar</Text>
